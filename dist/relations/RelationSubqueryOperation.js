...
var RelationSubqueryOperation =
/*#__PURE__*/
function (_QueryBuilderOperatio) {
  _inherits(RelationSubqueryOperation, _QueryBuilderOperatio);

  function RelationSubqueryOperation(name, opt) {
    var _this;

    _classCallCheck(this, RelationSubqueryOperation);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(RelationSubqueryOperation).call(this, name, opt));
    _this.relation = opt.relation;
    return _this;
  }

  _createClass(RelationSubqueryOperation, [{
    key: "onBuild",
  ...
  return RelationSubqueryOperation;
