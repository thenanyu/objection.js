...
var BelongsToOneInsertOperation = require('./BelongsToOneInsertOperation');

var BelongsToOneDeleteOperation = require('./BelongsToOneDeleteOperation');

var BelongsToOneRelateOperation = require('./BelongsToOneRelateOperation');

var BelongsToOneUnrelateOperation = require('./BelongsToOneUnrelateOperation');

var BelongsToOneRelation =
/*#__PURE__*/
function (_Relation) {
  _inherits(BelongsToOneRelation, _Relation);

  function BelongsToOneRelation() {
    _classCallCheck(this, BelongsToOneRelation);

    return _possibleConstructorReturn(this, _getPrototypeOf(BelongsToOneRelation).apply(this, arguments));
  }

  _createClass(BelongsToOneRelation, [{
    key: "isOneToOne",
