...
var RelationUpdateOperation =
/*#__PURE__*/
function (_UpdateOperation) {
  _inherits(RelationUpdateOperation, _UpdateOperation);

  function RelationUpdateOperation(name, opt) {
    var _this;

    _classCallCheck(this, RelationUpdateOperation);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(RelationUpdateOperation).call(this, name, opt));
    _this.relation = opt.relation;
    _this.owner = opt.owner;
    return _this;
  }

  _createClass(RelationUpdateOperation, [{
    key: "onBuild",
    value: function onBuild(builder) {
      _get(_getPrototypeOf(RelationUpdateOperation.prototype), "onBuild", this).call(this, builder);
