...
var OnErrorOperation =
/*#__PURE__*/
function (_QueryBuilderOperatio) {
  _inherits(OnErrorOperation, _QueryBuilderOperatio);

  function OnErrorOperation() {
    _classCallCheck(this, OnErrorOperation);

    return _possibleConstructorReturn(this, _getPrototypeOf(OnErrorOperation).apply(this, arguments));
  }

  _createClass(OnErrorOperation, [{
    key: "onAdd",
