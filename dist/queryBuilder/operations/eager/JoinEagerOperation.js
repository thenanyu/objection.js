...
var RelationJoinBuilder = require('./RelationJoinBuilder');

var JoinEagerOperation =
/*#__PURE__*/
function (_EagerOperation) {
  _inherits(JoinEagerOperation, _EagerOperation);

  function JoinEagerOperation(name, opt) {
    var _this;

    _classCallCheck(this, JoinEagerOperation);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(JoinEagerOperation).call(this, name, opt));
    _this.joinBuilder = null;
    return _this;
  }

  _createClass(JoinEagerOperation, [{
    key: "onAdd",
    value: function onAdd(builder, args) {
      var ret = _get(_getPrototypeOf(JoinEagerOperation.prototype), "onAdd", this).call(this, builder, args);
    ...
    key: "onBefore2",
    value: function onBefore2(builder) {
