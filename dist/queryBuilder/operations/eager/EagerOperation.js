...
function (_QueryBuilderOperatio) {
  _inherits(EagerOperation, _QueryBuilderOperatio);

  function EagerOperation(name, opt) {
    var _this;

    _classCallCheck(this, EagerOperation);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(EagerOperation).call(this, name, opt));
    _this.expression = null;
    _this.modifiers = null;
    return _this;
  }

  _createClass(EagerOperation, [{
    key: "onAdd",
