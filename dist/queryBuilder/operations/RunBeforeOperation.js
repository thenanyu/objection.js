...
var RunBeforeOperation =
/*#__PURE__*/
function (_QueryBuilderOperatio) {
  _inherits(RunBeforeOperation, _QueryBuilderOperatio);

  function RunBeforeOperation() {
    _classCallCheck(this, RunBeforeOperation);

    return _possibleConstructorReturn(this, _getPrototypeOf(RunBeforeOperation).apply(this, arguments));
  }

  _createClass(RunBeforeOperation, [{
    key: "onAdd",
