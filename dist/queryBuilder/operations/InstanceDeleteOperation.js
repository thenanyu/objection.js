...
var DeleteOperation = require('./DeleteOperation');

var _require = require('../../utils/assert'),
    assertHasId = _require.assertHasId;

var _require2 = require('../../utils/promiseUtils'),
    afterReturn = _require2.afterReturn;

var InstanceDeleteOperation =
/*#__PURE__*/
function (_DeleteOperation) {
  _inherits(InstanceDeleteOperation, _DeleteOperation);

  function InstanceDeleteOperation(name, opt) {
    var _this;

    _classCallCheck(this, InstanceDeleteOperation);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(InstanceDeleteOperation).call(this, name, opt));
    _this.instance = opt.instance;
    return _this;
  }

  _createClass(InstanceDeleteOperation, [{
    key: "onBefore2",
    ...
    value: function onBuild(builder) {
      _get(_getPrototypeOf(InstanceDeleteOperation.prototype), "onBuild", this).call(this, builder);
