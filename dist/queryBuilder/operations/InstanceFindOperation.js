...
var _require2 = require('../../utils/assert'),
    assertHasId = _require2.assertHasId;

var InstanceFindOperation =
/*#__PURE__*/
function (_FindOperation) {
  _inherits(InstanceFindOperation, _FindOperation);

  function InstanceFindOperation(name, opt) {
    var _this;

    _classCallCheck(this, InstanceFindOperation);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(InstanceFindOperation).call(this, name, opt));
    _this.instance = opt.instance;
    return _this;
  }

  _createClass(InstanceFindOperation, [{
    key: "onBuild",
    ...
    value: function onAfter3(builder, result) {
      var maybePromise = _get(_getPrototypeOf(InstanceFindOperation.prototype), "onAfter3", this).call(this, builder, result);
