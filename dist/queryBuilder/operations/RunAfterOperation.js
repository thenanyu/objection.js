...
var RunAfterOperation =
/*#__PURE__*/
function (_QueryBuilderOperatio) {
  _inherits(RunAfterOperation, _QueryBuilderOperatio);

  function RunAfterOperation() {
    _classCallCheck(this, RunAfterOperation);

    return _possibleConstructorReturn(this, _getPrototypeOf(RunAfterOperation).apply(this, arguments));
  }

  _createClass(RunAfterOperation, [{
    key: "onAdd",
