...
var UpsertGraphOperation = require('./UpsertGraphOperation');

var _require = require('../RelationExpression'),
    RelationExpression = _require.RelationExpression;

var UpsertGraphAndFetchOperation =
/*#__PURE__*/
function (_DelegateOperation) {
  _inherits(UpsertGraphAndFetchOperation, _DelegateOperation);

  function UpsertGraphAndFetchOperation(name, opt) {
    var _this;

    _classCallCheck(this, UpsertGraphAndFetchOperation);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(UpsertGraphAndFetchOperation).call(this, name, opt));

    if (!_this.delegate.is(UpsertGraphOperation)) {
  ...
  _createClass(UpsertGraphAndFetchOperation, [{
    key: "onAfter3",
    value: function onAfter3(builder) {
      var _this2 = this;
  ...
  return UpsertGraphAndFetchOperation;
}(DelegateOperation);
