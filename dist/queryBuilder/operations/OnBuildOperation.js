...
var OnBuildOperation =
/*#__PURE__*/
function (_QueryBuilderOperatio) {
  _inherits(OnBuildOperation, _QueryBuilderOperatio);

  function OnBuildOperation() {
    _classCallCheck(this, OnBuildOperation);

    return _possibleConstructorReturn(this, _getPrototypeOf(OnBuildOperation).apply(this, arguments));
  }

  _createClass(OnBuildOperation, [{
    key: "onAdd",
