...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
    ...
    return node;
      ...
      peg$c2 = function peg$c2(name, args, alias, list) {
    var node = {
      $name: alias || name,
      $relation: name,
      $modify: args || [],
    ...
    return node;
      ...
      peg$c3 = function peg$c3(name, args, alias, expr) {
    var node = {
      $name: alias || name,
      $relation: name,
      $modify: args || [],
    ...
    return node;
      ...
      peg$c6 = function peg$c6(alias) {
    return alias;
  },
      peg$c7 = function peg$c7(name) {
    return name.join('');
  },
      peg$c8 = /^[^[\](),. \t\r\n]/,
      ...
      peg$c14 = function peg$c14(args) {
    return args;
  },
      peg$c15 = ',',
      peg$c16 = peg$literalExpectation(',', false),
      peg$c17 = function peg$c17(arg) {
    return arg;
  },
      peg$c18 = /^[ \t\r\n]/,
    ...
    return list;
      ...
      peg$c27 = function peg$c27(items) {
    return items;
  },
      peg$c28 = function peg$c28(expr) {
    return expr;
  },
      peg$c29 = function peg$c29(sub) {
    return sub;
  },
      peg$currPos = 0,
      peg$savedPos = 0,
  ...
  function assertDuplicateRelation(node, expr) {
    if (expr.$name in node) {
      console.warn("Duplicate relation \"".concat(expr.$name, "\" in a relation expression. You should use \"a.[b, c]\" instead of \"[a.b, a.c]\". This will cause an error in objection 2.0")); // TODO: enable for v2.0.
      // const err = new Error();
